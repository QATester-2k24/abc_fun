...
const items = {
  A:{word:"Apple",image:"images/apple.svg",animation:"apple"},
  B:{word:"Ball",image:"images/ball.svg",animation:"ball"},
  C:{word:"Cat",image:"images/cat.svg",animation:"cat"},
  D:{word:"Dog",image:"images/dog.svg",animation:"dog"},
  E:{word:"Elephant",image:"images/elephant.svg",animation:"cat"},
  F:{word:"Fish",image:"images/fish.svg",animation:"ball"},
  G:{word:"Giraffe",image:"images/giraffe.svg",animation:"cat"},
  H:{word:"House",image:"images/house.svg",animation:"apple"},
  I:{word:"Ice Cream",image:"images/icecream.svg",animation:"ball"},
  J:{word:"Juice",image:"images/juice.svg",animation:"apple"},
  K:{word:"Kite",image:"images/kite.svg",animation:"butterfly"},
  L:{word:"Lion",image:"images/lion.svg",animation:"cat"},
  M:{word:"Monkey",image:"images/monkey.svg",animation:"cat"},
  N:{word:"Nest",image:"images/nest.svg",animation:"apple"},
  O:{word:"Orange",image:"images/orange.svg",animation:"apple"},
  P:{word:"Penguin",image:"images/penguin.svg",animation:"cat"},
  Q:{word:"Queen",image:"images/queen.svg",animation:"apple"},
  R:{word:"Rabbit",image:"images/rabbit.svg",animation:"cat"},
  S:{word:"Sun",image:"images/sun.svg",animation:"spin"},
  T:{word:"Tiger",image:"images/tiger.svg",animation:"cat"},
  U:{word:"Umbrella",image:"images/umbrella.svg",animation:"butterfly"},
  V:{word:"Van",image:"images/van.svg",animation:"ball"},
  W:{word:"Whale",image:"images/whale.svg",animation:"ball"},
  X:{word:"Xylophone",image:"images/xylophone.svg",animation:"spin"},
  Y:{word:"Yo-yo",image:"images/yoyo.svg",animation:"ball"},
  Z:{word:"Zebra",image:"images/zebra.svg",animation:"cat"}
};
